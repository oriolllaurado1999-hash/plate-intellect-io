...
import CurrentWeightStep from '@/components/onboarding/CurrentWeightStep';
...
const OnboardingPreview = () => {
  ...
  const renderStep = () => {
    switch (currentStep) {
      ...
      case 25:
        return <AuthStep onAuthSuccess={handleNext} onSkip={handleNext} />;
      case 26:
