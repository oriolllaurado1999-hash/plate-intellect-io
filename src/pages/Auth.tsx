  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-50 to-gray-100 flex flex-col items-center justify-center p-4 light relative">
      ...
      <Dialog open={showSignInModal} onOpenChange={setShowSignInModal}>
        <DialogContent className="w-[90%] max-w-xs mx-auto rounded-3xl bg-white border-none shadow-2xl p-6">
          <DialogHeader className="pb-2">
            <DialogTitle className="text-xl font-bold text-center text-gray-900 pt-1">
              Sign In
            </DialogTitle>
          </DialogHeader>
          ...
          <div className="space-y-3 pt-3 pb-4">
            ...
            <Button
              ...
              disabled={isLoading}
              className="w-full bg-black text-white hover:bg-black/90 h-11 text-sm font-semibold rounded-2xl flex items-center justify-center gap-2 border-none"
            >
            ...
            <Button
              ...
              disabled={isLoading}
              variant="outline"
              className="w-full bg-white text-gray-800 border-2 border-gray-300 hover:bg-gray-50 h-11 text-sm font-semibold rounded-2xl flex items-center justify-center gap-2"
            >
          ...
          <div className="text-center text-xs text-gray-600 pb-2 px-2">
