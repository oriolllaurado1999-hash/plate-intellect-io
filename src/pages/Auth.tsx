  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-50 to-gray-100 flex flex-col items-center justify-center p-4 light relative">
      ...
      <Dialog open={showSignInModal} onOpenChange={setShowSignInModal}>
        <DialogContent className="sm:max-w-md mx-4 rounded-3xl bg-white border-none shadow-2xl">
          <DialogHeader className="relative pb-2">
            ...
            <DialogTitle className="text-2xl font-bold text-center text-gray-900 pt-4">
              Sign In
            </DialogTitle>
          </DialogHeader>
          ...
          <div className="space-y-4 pt-6 pb-6">
            ...
            <Button
              ...
              disabled={isLoading}
              className="w-full bg-black text-white hover:bg-black/90 h-14 text-base font-semibold rounded-2xl flex items-center justify-center gap-3 border-none"
            >
            ...
            <Button
              ...
              disabled={isLoading}
              variant="outline"
              className="w-full bg-white text-gray-800 border-2 border-gray-300 hover:bg-gray-50 h-14 text-base font-semibold rounded-2xl flex items-center justify-center gap-3"
            >
